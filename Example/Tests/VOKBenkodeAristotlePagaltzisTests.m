...
- (void)test_decode
{
    ...
    AssertDecodingProducesError(@"i-0e");  // malformed integer data at 1\b | negative zero integer'
    ...
    AssertDecodingProducesError(@"02:xy");  // malformed string length at 0\b | string with extra leading zero in count'
    ...
    AssertDecodingProducesError(@"di1e0:e");  // dict key is not a string at 1 | dict with integer key'
    AssertDecodingProducesError(@"d1:a0:1:a0:e");  // duplicate dict key at 9 | duplicate keys'
    AssertDecodingProducesError(@"i03e");  // malformed integer data at 1 | integer with leading zero'
    AssertDecodingProducesError(@"l01:ae");  // malformed string length at 1 | list with string with leading zero in count'
    ...
    AssertDecodingProducesError(@"00:");  // malformed string length at 0 | zero-length string with extra leading zero in count'
    AssertDecodingProducesError(@"l-3:e");  // malformed string length at 1 | list with negative-length string'
    AssertDecodingProducesError(@"i-03e");  // malformed integer data at 1 | negative integer with leading zero'
